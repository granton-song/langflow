...
export const SIDEBAR_CATEGORIES = [
  { display_name: "保存", name: "saved_components", icon: "GradientSave" },
  { display_name: "输入", name: "inputs", icon: "Download" },
  { display_name: "输出", name: "outputs", icon: "Upload" },
  { display_name: "提示符", name: "prompts", icon: "TerminalSquare" },
  { display_name: "数据", name: "data", icon: "Database" },
  { display_name: "处理进度", name: "processing", icon: "ListFilter" },
  { display_name: "模型", name: "models", icon: "BrainCircuit" },
  { display_name: "向量存储", name: "vectorstores", icon: "Layers" },
  { display_name: "嵌入", name: "embeddings", icon: "Binary" },
  { display_name: "代理", name: "agents", icon: "Bot" },
  ...
  { display_name: "存储方式", name: "memories", icon: "Cpu" },
  ...
  { display_name: "工具程序", name: "toolkits", icon: "Package2" },
  { display_name: "工具", name: "tools", icon: "Hammer" },
  { display_name: "逻辑处理", name: "logic", icon: "ArrowRightLeft" },
  { display_name: "帮助", name: "helpers", icon: "Wand2" },
];
